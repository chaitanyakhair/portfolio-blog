...
export const EXPERIENCES: Experience[] = [
  {
    ...
    companyLogo: "/images/companies/freelancing.png",
    positions: [
      {
        ...
        icon: "code",
        description: `- Designed and Developed Landing Pages for multiple clients.
- Designed and Developed Portfolio Websites for multiple professionals.
- Build and maintain an Ecommerce website for a brand.
- Help update business website including designing and updating content and images.
- Integrated Payment gateway to accept payments online.
- Analyze technical capabilities and provide optimal solutions to clients.`,
        skills: [
          "Next.js",
          "ReactJS",
          "NodeJS",
  ...
  {
    id: "delishush",
    companyName: "Delishush.co.in",
    companyLogo: "images/companies/delishush.png",
    positions: [
      {
        ...
        employmentType: "Full-time",
        icon: "code",
        description: `External Project: [Tandenspine Webapp](https://app.tandenspine.io/)
- Managed the development of the webapp, including the integration of the backend API and the frontend UI.
- Used websocket to handle real-time communication between the frontend and the backend.
- Handled data of over 2000 users.

External Project: [Gutreset Website](https://gutreset.tandenspine.io/)
- Developed the website for Gutreset, including system design and development.
- Handled secure connection between the user and admin panel.
- Handled data of over 1000 users.`,
        skills: [
          "Next.js",
          "ReactJS",
          "NodeJS",
      ...
      },
      {
        ...
        icon: "design",
        description: `- Design UI/UX for Delishush Website with a seamless experience.
- Develop a Design System for consistency and efficiency.
- Create Delishush's brand identity, including logo and guidelines.`,
        skills: [
          "UI/UX Design",
          "Design System",
          "ReactJS",
